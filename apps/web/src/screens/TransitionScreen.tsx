      ...
      {isA && (
        <div style={{ position:'absolute', inset:0, background:'linear-gradient(165deg,#E84393,#BE2C76 60%,#7A1535)', display:'flex', alignItems:'center', justifyContent:'center' }}>
          ...
          <div style={{ position:'relative', textAlign:'center', padding:'0 36px' }}>
            ...
            <div style={{ fontFamily:"'Instrument Serif',serif", fontStyle:'italic', fontSize:62, lineHeight:.95, color:'#fff', margin:'8px 0 0', textShadow:'0 4px 24px rgba(120,20,60,.5)', animation:'dou-pop .8s ease .1s forwards' }}>{transTitle}</div>
      ...
      {isB && (
        <div style={{ position:'absolute', inset:0, overflow:'hidden', background:'linear-gradient(180deg,#9E1E5C 0%,#5E1233 55%,#33112A 100%)' }}>
          ...
          <div style={{ position:'absolute', inset:0, zIndex:2, display:'flex', alignItems:'center', justifyContent:'center', color:'#FFE3D2' }}>
            <div style={{ position:'absolute', fontFamily:"'Instrument Serif',serif", fontStyle:'italic', fontSize:230, lineHeight:.8, color:'rgba(255,255,255,.1)', animation:'dou-bignum 1s ease 1s forwards' }}>3</div>
            <div style={{ position:'relative', textAlign:'center', padding:'0 36px', animation:'dou-rise .8s ease 1.1s forwards' }}>
              ...
              <div style={{ fontFamily:"'Instrument Serif',serif", fontStyle:'italic', fontSize:58, lineHeight:.95, color:'#fff', margin:'8px 0 0', textShadow:'0 3px 18px rgba(80,10,40,.6)' }}>{transTitle}</div>
